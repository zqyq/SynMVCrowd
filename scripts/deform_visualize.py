...
from scripts.multiview_detector.utils import projection
from scripts.multiview_detector.utils.image_utils import img_color_denormalize
from scripts.multiview_detector.datasets import *
...
if __name__ == '__main__':
    ...
    # add breakpoint to L112@'multiview_detector/track_tacular_models/ops/modules/ms_deform_attn.py',
