...
def sinkhorn_tensorized(α, x, β, y, cam_loc, p=2, blur=.05, reach=None, diameter=None, scaling=.5, cost=None,
    ...
    # (B,N,N), (B,M,M)
    C_xy = cost(x, y.detach(), cam_loc)
    C_yx = torch.permute(C_xy, (0, 2, 1))  # (B,N,M), (B,M,N)
