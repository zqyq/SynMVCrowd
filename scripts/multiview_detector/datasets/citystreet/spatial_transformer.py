...
# import Ini_reduce_time_mul_height as Inir
import scripts.multiview_detector.datasets.citystreet.Ini_reduce_time_mul_height as Inir
...
class SpatialTransformer_v3:
    def __init__(self,
        ...
        self.person_heights = kwargs['person_heights'] if 'person_heights' in kwargs else [1750]
        self.proj_views_heights = {}
        self.view_gp_masks = []
        # for direct use of projection instaed of calculating every time.
        self.projection_files = kwargs['proj_root'] if 'proj_root' in kwargs else './projection_files'
...
if __name__ == '__main__':
    ...
    height = 1750
    img_path1 = '/mnt/d/Datasets/CityStreet/image_frames/camera1/frame_0636.jpg'
    img_path2 = '/mnt/d/Datasets/CityStreet/image_frames/camera3/frame_0636.jpg'
    img_path3 = '/mnt/d/Datasets/CityStreet/image_frames/camera4/frame_0636.jpg'
    ...
    STN = SpatialTransformer_v3(input_shape, proj_shape, 'cpu', person_heights=[height],
                                proj_root='/mnt/d/Pycharm_jobs/MVPUR/mvdetr_datasets/citystreet',
                                data_root='/mnt/d/Datasets/CityStreet')
    ...
    # 缩小至【96, 170, 3】
    inputs = torch.nn.functional.interpolate(inputs.permute(0, 3, 1, 2).float(), size=(96, 170), mode='bilinear',
                                             align_corners=False).permute(0, 2, 3, 1)
    outputimg = STN(inputs=inputs, height=height).int()
    res_dir = '/mnt/d/Yunfei/Study/Multi_model_test_results/Img_results'
