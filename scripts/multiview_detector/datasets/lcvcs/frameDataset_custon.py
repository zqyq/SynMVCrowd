...
class frameDataset(VisionDataset):
    def __init__(self, base, split='train', transform=ToTensor(), target_transform=ToTensor(),
        ...
        if split == 'train':
            ...
            self.file_path = os.path.join(data_file, 'test')
            self.label_file_path = os.path.join(label_file, 'test')
        else:
    ...
    def __getitem__(self, index):
        ...
        # label_path_list_sampling = random.sample(label_path_list_j, )
        ...
        return camera_paras, wld_map_paras, hw_random, scene_frame_cam

    def __len__(self):
        len_num = self.nb_scenes
