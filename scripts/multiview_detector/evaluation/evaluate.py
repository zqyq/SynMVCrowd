...
# from scripts.multiview_detector.evaluation.pyeval.evaluateDetection import evaluateDetection_py
...
def evaluate(res_fpath, gt_fpath, dataset='wildtrack',hd=2.5):
    # try:
    #     import matlab.engine
    #
    #     eng = matlab.engine.start_matlab()
    ...
    recall, precision, moda, modp = evaluateDetection_py(res_fpath, gt_fpath, dataset,hd=hd)
    return recall, precision, moda, modp
